...
const { getUsersBySchool, createUserRoute, getAllUsers, getUser, updateUser, deleteUser } = require('../controllers/usersController.js');
const user = require('../constants/users_table.js');

router.get(`/school/:${user.SCHOOL_ID}`, getUsersBySchool);
router.post(`/create/:${school.SCHOOL_ID}`, createUserRoute);
