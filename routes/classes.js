...
const { saveClass, updateClass, getAllClassesBySchoolIdAndCreatedYear, deleteClassByClassId, getClass, getClassListByYear } = require('../controllers/classesController');
const classes_table = require('../constants/classes_table');

router.get(`/year/:${classes_table?.CREATED_YEAR}`, getClassListByYear);
