...
const saveTeacherAttendanceByCreatedDate = async (school_id, created_by, created_date, teacher_id, is_present) => {
  ...
  const saveTeacherAttendanceQuery = `INSERT INTO teacher_attendance (
    ${teacher_attendance_table?.TEACHER_ID}, 
    ${teacher_attendance_table?.SCHOOL_ID}, 
    ${teacher_attendance_table?.CREATED_BY}, 
    ${teacher_attendance_table?.CREATED_DATE}, 
    ${teacher_attendance_table?.IS_PRESENT},
    ${teacher_attendance_table?.COMMENT}
  ) 
  ...
  RETURNING 
    ...
    ${teacher_attendance_table?.SCHOOL_ID},
    ${teacher_attendance_table?.CREATED_BY},
    to_char(${teacher_attendance_table?.CREATED_DATE}, 'YYYY-MM-DD') as ${teacher_attendance_table?.CREATED_DATE},
    ${teacher_attendance_table?.IS_PRESENT},
    ${teacher_attendance_table?.COMMENT},
  created_on`;
